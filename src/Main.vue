<template>
    ...
    <!--  section -->
		<section>
			<div class="main">
				<ul>
					<li><router-link :to="{ name: 'store-page' }"><img src="http://m.mk.co.kr/images/2018/franchise/btn_fc03.png" alt="우리동네매장"><span>우리동네<br>매장</span></router-link></li>
					<li><a href="#"><img src="http://m.mk.co.kr/images/2018/franchise/btn_fc04.png" alt="상가매물"><span>상가 매물</span></a></li>
				</ul>
				<ul>
